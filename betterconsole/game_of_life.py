            ...
            for y_index, y in enumerate(x):
                ...
                for x_c in range(-1, 2):
                    for y_c in range(-1, 2):
                        ...
                        if self.area[new_x][new_y] == 'x':
                            nerbly += 1
                if self.area[x_index][y_index] == 'x':
                    ...
                    if nerbly < 2:
                        ...
                        self.new_area[x_index][y_index] = 'x'
                        #print('im ok')
...
def main():
    Game = Game_of_life(30, 30)
    Game.set_cells(10,10)
    Game.set_cells(10, 11)
    Game.set_cells(10, 12)
    area = Game.get_area()
    while 1:
